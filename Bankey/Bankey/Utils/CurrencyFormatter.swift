...
struct CurrencyFormatter {
    ...
    private func convertDollar(_ dollarPart: Double) -> String {
        ...
        //to poniżej niepotrzebne i generuje błąd (jesli nie ma lini o locale, co udowadniają printy
        //print("dollars before remove first \(dollars)")
        dollars.removeFirst() // "929,466"
        //print("dollars after remove first \(dollars)")
        return dollars
    }
