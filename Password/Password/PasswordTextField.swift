...
extension PasswordTextField {
    ...
    func style() {
        ...
        textField.keyboardType = .asciiCapable //klawiatura bez emoji
...
//        sposób pierwszy: zmniejszanie tekstu, do minimalnej skali
//        errorLabel.adjustsFontSizeToFitWidth = true
//        errorLabel.minimumScaleFactor = 0.8
        
//        sposób dwa: tworzenie większej ilości linii
    ...
    func layout() {
        ...
        // CHCR - który element się rozciągnie
...
extension PasswordTextField: UITextFieldDelegate {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        textField.endEditing(true) // resign first responder i znika klawiaturę
        return true
    }
}
