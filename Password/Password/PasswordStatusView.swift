...
//  Password
//
//  Created by Tomasz Rygula on 27/09/2023.
//
...
extension PasswordStatusView {
    ...
    func style() {
        ...
        stackView.spacing = 8
        //stackView.distribution = .equalCentering - potrzebne było żeby rozmieścić kołeczka równo w danym intrinsic contnent size 200
...
extension PasswordStatusView {
    ...
    func validate(_ text: String) -> Bool {
        ...
        let metCriteria = checkable.filter { $0 } //zlicza kiedy checkable zwraca true
        let lengthAndNoSpaceMet = PasswordCriteria.lengthAndNoSpaceMet(text)
